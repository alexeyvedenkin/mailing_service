...
from mailwork.views import (HomeTemplateView, MessageCreateView, MessageDeleteView, MessageDetailView, MessageListView,
                            ...
                            unpublish_message, SendingAttemptListView)
...
urlpatterns = [
    ...
    path("newsletter/start/<int:pk>/", newsletter_start, name="newsletter_start"),
    ...
    # Попытки рассылок
    path('sending-attempts/', SendingAttemptListView.as_view(), name='sending_attempts'),
]
